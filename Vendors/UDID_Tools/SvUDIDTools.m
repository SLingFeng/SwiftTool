...
//        char kKeyChainUDIDAccessGroup[] = [str UTF8String];
...
+ (NSString*)getUDIDFromKeyChain
{
    ...
    NSString *accessGroup = NSBundle.mainBundle.bundleIdentifier;//[NSString stringWithUTF8String:kKeyChainUDIDAccessGroup];
    if (accessGroup != nil)
    {
