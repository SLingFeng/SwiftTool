...
@property (nonatomic, assign) BOOL reverseSelf;
...
- (void)setProgressWithAnimated:(BOOL)animated {
    ...
    CGRect rect = CGRectMake(0, 0, _progress * kWidth, kHeight);
    
    if (self.reverseSelf) {
        rect = CGRectMake((_progress * kWidth), 0, kWidth, kHeight);
    }
...
- (void)setProgress:(float)progress animated:(BOOL)animated {
    ...
    XDProgressLayer * xdLayer = (XDProgressLayer *)self.layer;
    xdLayer.reverseSelf = self.reverseSelf;
