...
- (void)setPageControlDotSize:(CGSize)pageControlDotSize
{
    ...
    if ([self.pageControl isKindOfClass:[EllipsePageControl class]]) {
        EllipsePageControl *pageContol = (EllipsePageControl *)_pageControl;
        pageContol.controlSize = pageControlDotSize.width;
    }
}
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case SDCycleScrollViewPageContolStyleAnimated:
        {
            ...
            pageControl.controlSize = _pageControlDotSize.width;
